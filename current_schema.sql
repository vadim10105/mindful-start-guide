...
CREATE TABLE IF NOT EXISTS "public"."tasks" (
    ...
    "difficulty" "public"."task_difficulty" DEFAULT 'neutral'::"public"."task_difficulty",
    ...
    "later_at" timestamp with time zone
);
...
CREATE UNIQUE INDEX "idx_tasks_user_card_position_unique" ON "public"."tasks" USING "btree" ("user_id", "card_position") WHERE ("status" = 'active'::"public"."task_status");
