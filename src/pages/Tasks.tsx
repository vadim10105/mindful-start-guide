...
const Tasks = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className={`${currentStep === 'game-cards' ? 'w-full' : currentStep === 'input' ? 'max-w-4xl mx-auto flex items-center justify-center min-h-screen' : 'max-w-4xl mx-auto'} space-y-6`}>
