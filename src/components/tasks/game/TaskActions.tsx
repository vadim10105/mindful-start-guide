  ...
  return (
    <>
      ...
      >
        ...
        {shouldShowPlay ? (
          <Play className={`w-4 h-4 flex-shrink-0 ${isPaused ? 'text-white' : 'task-action-icon'} group-hover:text-white transition-colors duration-300 relative z-10`} />
        ) : (
          <Pause className={`w-4 h-4 flex-shrink-0 ${isPaused ? 'text-white' : 'task-action-icon'} group-hover:text-white transition-colors duration-300 relative z-10`} />
        )}
      ...
      {!isPaused && isActiveCommitted && (
        ...
        >
          ...
          <TrendingUp className="w-4 h-4 flex-shrink-0 task-action-icon group-hover:text-white transition-colors duration-300 relative z-10" />
          <span className="max-w-0 group-hover:max-w-[100px] overflow-hidden whitespace-nowrap text-sm font-medium text-white opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out relative z-10">
            Save
          </span>
        </button>
      ...
      {!isPaused && isActiveCommitted && (
        ...
        >
          ...
          <Check className="w-4 h-4 flex-shrink-0 task-action-icon group-hover:text-white transition-colors duration-300 relative z-10" />
          <span className="max-w-0 group-hover:max-w-[100px] overflow-hidden whitespace-nowrap text-sm font-medium text-white opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out relative z-10">
            Finish
          </span>
        </button>
      ...
      {!isPaused && isActiveCommitted && (
        ...
        >
          ...
          {isGenerating ? (
            <Loader2 className="w-4 h-4 flex-shrink-0 task-action-icon group-hover:text-white transition-colors duration-300 relative z-10" style={{ animation: 'spin 2s linear infinite' }} />
          ) : (
            <Wand2 className="w-4 h-4 flex-shrink-0 task-action-icon group-hover:text-white transition-colors duration-300 relative z-10" />
          )}
          <span className="max-w-0 group-hover:max-w-[100px] overflow-hidden whitespace-nowrap text-sm font-medium text-white opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out relative z-10">
            Split
          </span>
      ...
      >
        ...
        {pipWindow ? (
          <Minimize2 className={`w-4 h-4 flex-shrink-0 ${isPaused ? 'text-white' : 'task-action-icon'} group-hover:text-white transition-colors duration-300 relative z-10`} />
        ) : (
          <ExternalLink className={`w-4 h-4 flex-shrink-0 ${isPaused ? 'text-white' : 'task-action-icon'} group-hover:text-white transition-colors duration-300 relative z-10`} />
        )}
        <span className="max-w-0 group-hover:max-w-[100px] overflow-hidden whitespace-nowrap text-sm font-medium text-white opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out relative z-10">
